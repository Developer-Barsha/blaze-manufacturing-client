...
const MyOrders = () => {
    ...
    //fetching and getting orders by user email
    useEffect(() => {
    ...
    return (
        <div>
            <div className="flex justify-center h-screen mt-auto items-center overflow-auto">
                {modal}
                {orders.length > 0 ?
                    <table className="table my-auto border">
                        {/* <!-- table head --> */}
                        <thead>
                            <tr>
                                <th></th>
